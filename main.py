...
# ============================================================
# BOEING 777 VISUAL SPEC PANEL
# ============================================================

st.markdown("---")
st.header("Boeing 777-300 Technical Overview")

colA, colB = st.columns([2,1])

with colA:
    st.image(
        "https://upload.wikimedia.org/wikipedia/commons/5/5f/Boeing_777-300ER_side_view.png",
